...
{{ read_csv("../../data/csv/criterion-collection-spines.csv") }}

### box sets 盒装和多集电影

{{ read_csv("../../data/csv/criterion-collection-boxsets.csv") }}
...
![Eclipse Box Sets](../assets/images/criterion-collection-eclipse-series.png)

{{ read_csv("../../data/csv/criterion-collection-eclipse-series.csv") }}
